...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
    <table class="table table-success table-striped width=20px">
    <thead class="text-center">
        ...
        <tbody class="text-center">
            ...
            <div class="col-lg-3">
                ...
                <input class="form-check-input" type="checkbox" name="pay_mode" value="COD" id="flexCheckDefault">
                <label class="form-check-label" for="flexCheckDefault">
                Cash on delivery
                </label>
                </div>
                <button class="btn btn-primary btn-block" name="purchase">Make Purchese</button>
                </form>
                <?php
                    }
                ?>
